...
public class UserService {
	...
	public List<User> fetchListAdmins() {
		return userRepository.getListAdmins();
	}
	...
	public List<User> fetchListEtudiantsAffectesAEncadrant(Long encadrant_id) {
		return userRepository.getListEtudiantsAffectesAEncadrant(encadrant_id);
	}
